...
export class GridHelper extends LineSegments {
	/**
	 * @param size Размер сетки по осям X и Z. По умолчанию 10.
	 * @param divisions Количество делений сетки. По умолчанию 10.
	 * @param colorCenterLine Цвет центральной линии. По умолчанию 0x444444.
	 * @param colorGrid Цвет основных линий сетки. По умолчанию 0x888888.
	 */
