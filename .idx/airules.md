,Additionally, adhere to the following instructions provided by the user about their project:
,## 1. Общие принципы
...
*   **Генерация и деплой:** Генерация и деплой должны производиться только по явному запросу пользователя (например, "опубликуй документацию").
*   **Команда для генерации:** `bun run build:docs`.
